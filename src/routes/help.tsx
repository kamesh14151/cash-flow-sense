    ...
    <AppShell>
      <div className="mb-6">
        ...
        <p className="text-[13px] text-muted-foreground mt-0.5">
          Understanding Cash-Flow Copilot concepts and workflows
        </p>
      </div>

      {/* Core concept */}
      <div className="bg-foreground text-background rounded-lg p-6 mb-6">
        <h2 className="text-xl font-bold mb-2">NOT EVERY INCOME DROP MEANS THE SAME THING.</h2>
        <p className="text-background/70 text-[13px] leading-relaxed max-w-xl">
          Cash-Flow Copilot distinguishes between Seasonal Dips — temporary, pattern-matched income drops — and
          Structural Decline — persistent, unexplained deterioration. The system recommends different interventions
          for each, and requires officer approval before any action is taken.
        </p>
        <div className="flex gap-4 mt-4">
          <div className="border border-background/20 rounded px-4 py-2">
            <p className="text-[12px] font-semibold text-background/60">SEASONAL DIP</p>
            <p className="text-[13px] text-background">Pattern-matched · Temporary</p>
          </div>
          <div className="border border-background/20 rounded px-4 py-2">
            <p className="text-[12px] font-semibold text-background/60">STRUCTURAL DECLINE</p>
            <p className="text-[13px] text-background">Persistent · Unexplained</p>
          </div>
        </div>
      </div>
